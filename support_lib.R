...
CompareRanking <-function(player1,player2) {
        ...
        pos.range <-range(toplot.rank$Pos,1)
        ...
        abline(h=10, col="darkgreen", lty=3)
        abline(h=15, col="darkmagenta", lty=3)        
        abline(h=30, col="darkgrey", lty=3)
        abline(h=1, col="gold", lty=3, lwd=2)
